...
rounded-lg shadow-lg">
  ...
  <form class="mt-4" method="POST" action="{{ route('register.post') }}">
    ...
    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Celular"
    id="celular_usuario" name="celular_usuario">

    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Direccion"
    id="login_usuariobre" name="direccion_usuario">

    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full
    text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Municipio"
    id="id_municipio_usuario" name="id_municipio_usuario">
